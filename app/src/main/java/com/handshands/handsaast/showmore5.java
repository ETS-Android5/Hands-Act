...
public class showmore5 extends AppCompatActivity {
    RecyclerView r1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_showmore5);
        ...
        ref1.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                topkeeperadapter topadapter=new topkeeperadapter(list1,showmore5.this);
