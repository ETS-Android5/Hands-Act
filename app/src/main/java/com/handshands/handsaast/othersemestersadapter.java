...
public class othersemestersadapter extends RecyclerView.Adapter<othersemestersadapter.mh> {
    ArrayList<engsemesterinheret>list;
    Activity context;
    public othersemestersadapter(ArrayList<engsemesterinheret> list, Activity context) {
        this.list = list;
