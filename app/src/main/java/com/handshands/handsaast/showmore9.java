...
public class showmore9 extends AppCompatActivity {
    RecyclerView r1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_showmore9);
        list1=new ArrayList<>();
        r1.setLayoutManager(new LinearLayoutManager(this,LinearLayoutManager.VERTICAL,false));
        ref1= FirebaseDatabase.getInstance().getReference("topleague").child("sup");
        ref1.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                topkeeperadapter topadapter=new topkeeperadapter(list1,showmore9.this);
