...
public class valorantgroupsadapter extends RecyclerView.Adapter<valorantgroupsadapter.mh> {
    ArrayList<groupainheret> list;
    Activity con;

    public valorantgroupsadapter(ArrayList<groupainheret> list, Activity con) {
        this.list = list;
        this.con = con;
    }
    ...
    @NonNull
    @Override
    public valorantgroupsadapter.mh onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(con).inflate(R.layout.grouparaw,parent,false);
        return new mh(view);
    }

    @Override
    public void onBindViewHolder(@NonNull valorantgroupsadapter.mh holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(con,valorantteams.class);
