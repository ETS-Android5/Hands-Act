...
public class valorantresult extends AppCompatActivity {
    RecyclerView r1, r2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_valorantresult);
        calling();
        list = new ArrayList<>();
        list2 = new ArrayList<>();
        ...
        l1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent j=new Intent(valorantresult.this,valorantteams.class);
        ...
        l2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(valorantresult.this,valorantteams.class);
        ...
        reference = FirebaseDatabase.getInstance().getReference("valorantdetails").child(c);
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                valorantdetailsadapter lastchatadapter = new valorantdetailsadapter(list, valorantresult.this);
        ...
        reference2 = FirebaseDatabase.getInstance().getReference("valorantscores").child(s);
        reference2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                valorantscoreadapter lastchatadapter = new valorantscoreadapter(list2, valorantresult.this);
